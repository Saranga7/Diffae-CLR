...
class Classifier_Component(nn.Module):
    ...
    def __init__(self, classifier_checkpoint_path, style_dim, num_classes = 2):
        super().__init__()
        self.mobile_net = torch.hub.load('pytorch/vision:v0.8.0', 'mobilenet_v2')
        self.mobile_net.classifier[1] = nn.Linear(1280, num_classes)
        self.mobile_net.load_state_dict(torch.load(classifier_checkpoint_path), strict = True)# map_location = device))
...
class BeatGANsAutoencModel(BeatGANsUNetModel):
    def __init__(self, conf: BeatGANsAutoencConfig):
        ...
        classifier_path = "/projects/deepdevpath2/Saranga/diffae/checkpoints/classifier/FFHQ_Gender.pth"
